...
const ProjectCard = memo(function ProjectCard({
  ...
  return (
    <div
      className={`project-card relative rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 ease-out transform-gpu
    ...
    >
      <div
        className={`absolute inset-0 bg-gradient-to-br ${project.bgColor} transition-all duration-300 ${
      ...
      <div className="absolute inset-0 p-6 lg:p-8">
        ...
        {expanded && (
          ...
          >
            ...
            >
              <div
                className={`bg-gradient-to-br from-gray-800 to-black rounded-2xl shadow-2xl flex items-center justify-center overflow-hidden border-2 border-pink-500/20 ${
            ...
            >
              <h3
                className={`font-bold text-white mb-4 lg:mb-6 leading-tight bg-gradient-to-r from-red-400 via-pink-400 to-purple-400 bg-clip-text text-transparent ${
...
export default function ProjectsSlider() {
  ...
  const isExpanded = useCallback(
    (index) =>
      index === hoveredProject || (isMobile && index === activeProject),
